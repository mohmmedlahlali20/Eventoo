        ...
        <form  action="{{ route('Event.update', ['Event' => $Event->id]) }}" method="post" enctype="multipart/form-data" >
          ...
          <div class="grid gap-6 mb-6 md:grid-cols-2">
              ...
              <div>
                  ...
                  <input type="number" name="places_number" value="{{ $Event->places_number}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="number of place"  />
              </div>
          </div>
          ...
          <div class="mb-4">
            ...
            <select name="category" id="category" value="{{ $Event->category }}" class="form-select text-black w-full px-4 py-2 border-2 border-gray-300 rounded focus:outline-none focus:border-blue-500" >
